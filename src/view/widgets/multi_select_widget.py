...
class MultiSelectionWidget:
    ...
    def create_multi_select_component(self, multi_select_config):
        ...
        """
        multi_select_register_value = multi_select_config.get(
            c.MULTI_SELECT_REGISTER_AS_KEY
        )
        if multi_select_register_value == "item_filter":
            ...
            return item_filter_widget.create_item_filter_multi_select(
                multi_select_config
            )
            ...
            return upper_item_filter_widget.create_upper_item_filter_multi_select(
                multi_select_config
            )
            ...
            return reco_filter_widget.create_reco_filter_multi_select(
                multi_select_config
            )
            ...
            return model_choice_widget.create_model_choice_multi_select(
                multi_select_config
            )
        else:
