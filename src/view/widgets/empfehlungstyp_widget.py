...
class EmpfehlungstypWidget(pn.Column, UIWidget):
    ...
    def create(self) -> pn.Column:
        ...
        radio_box_group.params = {
            "label": 'empfehlungstyp',
            "reset_to": 'Ähnlichkeit'
        }

        # Watch the value change
        radio_box_group_watcher = radio_box_group.param.watch(self.update_buttons, 'value', onlychanged=True,)
        ...
        self.col = pn.Column()
        self.col.append(radio_box_group)
    ...
    async def update_buttons(self, event):
        ...
        await self.reco_explorer_app_instance.trigger_reco_filter_choice(event)
