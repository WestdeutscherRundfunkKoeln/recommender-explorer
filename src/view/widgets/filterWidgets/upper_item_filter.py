...
class UpperItemFilterWidget:
    ...
    def create_upper_item_filter_multi_select(self, multi_select_config):
       ...
       """
        upper_item_filter_widget = self.multi_select_widget_instance.build_multi_select_widget(multi_select_config)
        ...
        if upper_item_filter_widget and linked_filter_name and filter_category:
            upper_item_filter_widget.param.watch(
                lambda event: self.controller_instance.load_options_after_filter_got_set(linked_filter_name, filter_category, upper_item_filter_widget, event),
                'value',
                onlychanged=True
            )
