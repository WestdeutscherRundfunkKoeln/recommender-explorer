...
def mock_date_component(date_values: dict, position: str) -> object:
    ...
    if position == "start":
        date_choice.value = datetime(2000, 1, 1, 0, 0, 0, 0)
    else:
...
def mock_start_and_reco_items_with_duplicates() -> object:
    start_item = ContentItemDto(
        _position=constants.ITEM_POSITION_START,
        _item_type=constants.ITEM_TYPE_CONTENT,
        _provenance=constants.ITEM_PROVENANCE_C2C,
        description="Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam",
        crid="crid://video1",
    )
    reco_items = [
        ContentItemDto(
            _position=constants.ITEM_POSITION_RECO,
            _item_type=constants.ITEM_TYPE_CONTENT,
            _provenance=constants.ITEM_PROVENANCE_C2C,
            description="nonumy eirmod tempor invidunt ut labore",
            crid="crid://video2",
        ),
        ContentItemDto(
            _position=constants.ITEM_POSITION_RECO,
            _item_type=constants.ITEM_TYPE_CONTENT,
            _provenance=constants.ITEM_PROVENANCE_C2C,
            description="et dolore magna aliquyam erat, sed diam voluptua.",
            crid="crid://video1",
        ),
        ContentItemDto(
            _position=constants.ITEM_POSITION_RECO,
        ...
        ContentItemDto(
            ...
            _item_type=constants.ITEM_TYPE_CONTENT,
            _provenance=constants.ITEM_PROVENANCE_C2C,
            description="no sea takimata sanctus est Lorem ipsum dolor sit amet.",
            crid="crid://video2",
        ),
        ContentItemDto(
            _position=constants.ITEM_POSITION_RECO,
