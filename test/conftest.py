...
@pytest.fixture
def controller(start_component: list, config: EnvYAML) -> RecommendationController:
...
@pytest.fixture
def u2c_controller(
    start_component: list, model: list, config: EnvYAML
...
@pytest.fixture
def c2c_controller(
    selection_type: str, start_component: list, model: list, config: EnvYAML
) -> RecommendationController:
